...
export default function FreelancerMessagesPage() {
  const conversations = [
    { id: 1, name: "John Doe (Client)", lastMessage: "Can you send the invoice?", time: "11:20 AM", unread: 1, active: true },
    { id: 2, name: "Acme Corp", lastMessage: "Project requirements attached.", time: "Yesterday", unread: 0, active: false },
  ]

  const currentChat = [
    { id: 1, text: "Hi John, I've completed the milestone.", sender: "me", time: "11:00 AM" },
    { id: 2, text: "Great! Can you send the invoice?", sender: "them", time: "11:20 AM" },
  ]
      ...
      <div className="w-80 border-r border-gray-200 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          {conversations.map((chat) => (
            <div key={chat.id} className={`p-4 border-b border-gray-50 hover:bg-gray-50 cursor-pointer transition-colors ${chat.active ? 'bg-purple-50/50' : ''}`}>
      ...
      <div className="flex-1 flex flex-col">
          ...
          {currentChat.map((msg) => (
            <div key={msg.id} className={`flex ${msg.sender === 'me' ? 'justify-end' : 'justify-start'}`}>
              <div className={`max-w-[70%] rounded-2xl p-4 ${
                ...
                <div className={`text-[10px] mt-1 text-right ${msg.sender === 'me' ? 'text-purple-100' : 'text-gray-400'}`}>
                  {msg.time}
                </div>
              </div>
            </div>
        ...
        <div className="p-4 bg-white border-t border-gray-100">
          <div className="flex gap-2">
             ...
             <Button className="bg-purple-600 hover:bg-purple-700 text-white rounded-xl aspect-square p-0 w-10 flex items-center justify-center">
