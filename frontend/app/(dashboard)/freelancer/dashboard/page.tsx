...
export default function FreelancerDashboardPage() {
  const stats = [
    { title: "Total Earnings", value: "Rs.,450", icon: DollarSign, trend: { value: 15, isPositive: true }, gradient: "primary" as const },
  ...
  const recentOrders = [
    { id: 1, client: "Acme Corp", service: "Website Redesign", due: "2 days", amount: "Rs.,200", status: "In Progress" },
    { id: 2, client: "StartUp Inc", service: "Logo Design", due: "1 week", amount: "Rs.", status: "Not Started" },
    { id: 3, client: "John Doe", service: "Consultation", due: "Today", amount: "Rs.", status: "Review" },
  ]
