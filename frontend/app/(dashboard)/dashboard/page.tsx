...
export default function DashboardPage() {
  const stats = [
    ...
    { title: "Total Spent", value: "Rs.,250", icon: CreditCard, trend: { value: 12, isPositive: true }, gradient: "secondary" as const },
  ...
  const recentProposals = [
    { id: 1, service: "Website Redesign", freelancer: "Alex Walker", date: "2 hours ago", status: "Pending Review", amount: "Rs." },
    { id: 2, service: "SEO Content Pack", freelancer: "Mike Johnson", date: "1 day ago", status: "Accepted", amount: "Rs." },
    { id: 3, service: "Logo Design", freelancer: "Sarah Chen", date: "3 days ago", status: "Completed", amount: "Rs." },
  ]
